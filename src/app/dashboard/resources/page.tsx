              ...
              <CardContent className="flex-grow">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className={`flex items-center ${resource.trend === 'up' ? 'text-green-500' : resource.trend === 'down' ? 'text-red-500' : 'text-yellow-500'}`}>
                    {resource.trend === 'up' && <TrendingUp className="mr-1 h-4 w-4" />}
                    {resource.trend === 'down' && <TrendingUp className="mr-1 h-4 w-4 transform rotate-180" />}
                    {resource.trend === 'stable' && <TrendingUp className="mr-1 h-4 w-4 transform rotate-90" />}
