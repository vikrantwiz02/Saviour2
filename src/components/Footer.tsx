    ...
    <footer className="bg-blue-400 text-black py-8 font-sans">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/services" className="hover:text-blue-300 transition-colors">Our Services</Link></li>
              <li><Link href="/contact" className="hover:text-blue-300 transition-colors">Contact Us</Link></li>
              <li><Link href="/donate" className="hover:text-blue-300 transition-colors">Donate</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-blue-700 pt-8 text-center">
          <p className="text-sm">&copy; 2024 SAVIOUR. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
